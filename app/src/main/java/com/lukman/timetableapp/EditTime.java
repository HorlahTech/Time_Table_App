...
public class EditTime extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tstart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog onTimeSetListener = new TimePickerDialog(EditTime.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
    ...
    private void updatetTime() {
        ...
        if (tSTart == start || tStop == stop) {
            Toast.makeText(this, "Enter Time to Start and Time to Stop the Exam", Toast.LENGTH_LONG).show();
        } else {
            Toast.makeText(this, tSTart + "time to Start is  Submitted: " + "\n" + tStop + "Time to Stop is Submitted ", Toast.LENGTH_SHORT).show();
            ...
            long newRowId = db.update(TImeTableContract.TimeEntry.TABLE_NAME, values, "_id = ?", new String[]{id});
